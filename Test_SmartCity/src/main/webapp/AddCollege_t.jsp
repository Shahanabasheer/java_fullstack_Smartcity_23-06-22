...
<body id="body_Addcollege">
	...
	<div class="add_college" id="">
		...
		<form action="" name="addCollegeFM" id="addCollegeFM">
			<div id="addCollege_div1">
				<fieldset>
					<legend></legend>

					<label id="cname">Name of college:</label><input type="text"
						name="collegeName" id="collegeName"><br>
					<label>Place:</label> <input type="text" name="collegePlace"
						id="collegePlace"><br> <label>Affiliation</label><input
						type="text" name="collegeAffiliation" id="collegeAffiliation"><br>
					...
					<div id="addCollege_div3">
						...
						<ul>
							<li><label class="radio-inline">Arts and Science<input
									type="radio" name="coursetype" id="coursetype"
							...
							<li><label class="radio-inline">Medical<input
									type="radio" name="coursetype" id="coursetype" value="medical"></label></li>
							<li><label class="radio-inline">Management<input
									type="radio" name="coursetype" id="coursetype"
									value="management"></label></li>
							<li><label class="radio-inline">Others<input
									type="radio" name="coursetype" id="coursetype" value="others"></label></li>
						</ul>
					</div>
